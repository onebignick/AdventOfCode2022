with open('input.txt', 'r') as file:
    ...
    for line in lines:
        ...
        result3 = a_lowbound <= b_lowbound <= a_highbound <= b_highbound
        result4 = b_lowbound <= a_lowbound <= b_highbound <= a_highbound
        if result1 or result2 or result3 or result4 == True:
            total += 1
